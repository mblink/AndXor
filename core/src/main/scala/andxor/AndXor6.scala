...
trait AndXor6[A1, A2, A3, A4, A5, A6] extends AndXorNested6[AndXorConst[A1]#AXO, AndXorConst[A2]#AXO, AndXorConst[A3]#AXO, AndXorConst[A4]#AXO, AndXorConst[A5]#AXO, AndXorConst[A6]#AXO] {
