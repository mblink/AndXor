...
trait AndXor9[A1, A2, A3, A4, A5, A6, A7, A8, A9] extends AndXorNested9[AndXorConst[A1]#AXO, AndXorConst[A2]#AXO, AndXorConst[A3]#AXO, AndXorConst[A4]#AXO, AndXorConst[A5]#AXO, AndXorConst[A6]#AXO, AndXorConst[A7]#AXO, AndXorConst[A8]#AXO, AndXorConst[A9]#AXO] {
  override def derivingId[TC[_]](implicit t0: TC[A1], t1: TC[A2], t2: TC[A3], t3: TC[A4], t4: TC[A5], t5: TC[A6], t6: TC[A7], t7: TC[A8], t8: TC[A9]): AndXorDeriving[TC, Cop[Id], Prod[Id]] = deriving[TC, Id]
}
