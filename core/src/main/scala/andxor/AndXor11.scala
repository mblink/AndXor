...
trait AndXor11[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11] extends AndXor {
  case class ProdT[F[_]](run: (F[A1], (F[A2], (F[A3], (F[A4], (F[A5], (F[A6], (F[A7], (F[A8], (F[A9], (F[A10], F[A11])))))))))))
  object ProdT {

    implicit def lifta0[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A1]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((x, (t.t2, (t.t3, (t.t4, (t.t5, (t.t6, (t.t7, (t.t8, (t.t9, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta1[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A2]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (x, (t.t3, (t.t4, (t.t5, (t.t6, (t.t7, (t.t8, (t.t9, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta2[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A3]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (x, (t.t4, (t.t5, (t.t6, (t.t7, (t.t8, (t.t9, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta3[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A4]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (t.t3, (x, (t.t5, (t.t6, (t.t7, (t.t8, (t.t9, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta4[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A5]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (t.t3, (t.t4, (x, (t.t6, (t.t7, (t.t8, (t.t9, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta5[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A6]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (t.t3, (t.t4, (t.t5, (x, (t.t7, (t.t8, (t.t9, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta6[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A7]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (t.t3, (t.t4, (t.t5, (t.t6, (x, (t.t8, (t.t9, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta7[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A8]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (t.t3, (t.t4, (t.t5, (t.t6, (t.t7, (x, (t.t9, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta8[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A9]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (t.t3, (t.t4, (t.t5, (t.t6, (t.t7, (t.t8, (x, (t.t10, t.t11))))))))))))
    }
    ...
    implicit def lifta9[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A10]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (t.t3, (t.t4, (t.t5, (t.t6, (t.t7, (t.t8, (t.t9, (x, t.t11))))))))))))
    }
    ...
    implicit def lifta10[F[_]](implicit M: Monoid[ProdT[F]]): Inj[ProdT[F], F[A11]] = {
      val t = M.zero.run
      Inj.instance(x => ProdT((t.t1, (t.t2, (t.t3, (t.t4, (t.t5, (t.t6, (t.t7, (t.t8, (t.t9, (t.t10, x))))))))))))
    }
  ...
  case class CopT[F[_]](run: (F[A1] \/ (F[A2] \/ (F[A3] \/ (F[A4] \/ (F[A5] \/ (F[A6] \/ (F[A7] \/ (F[A8] \/ (F[A9] \/ (F[A10] \/ F[A11])))))))))))
  object CopT {
  ...
  def combine[F[_], G[_]](implicit a0: G[F[A1]], a1: G[F[A2]], a2: G[F[A3]], a3: G[F[A4]], a4: G[F[A5]], a5: G[F[A6]], a6: G[F[A7]], a7: G[F[A8]], a8: G[F[A9]], a9: G[F[A10]], a10: G[F[A11]])
    ...
    new ComposeAndXor[F, G, Cop, Prod] {
      ...
      def mkAlt[B](f: Cop[F] => B)(implicit a: Alt[G]): G[B] =
        Combine.altly11(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)(x => f(CopT(x)))
      ...
      def mkApply[B](f: Prod[F] => B)(implicit a: Apply[G]): G[B] =
        Combine.apply11(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
          case (i0, (i1, (i2, (i3, (i4, (i5, (i6, (i7, (i8, (i9, i10)))))))))) =>
            f(ProdT((i0, (i1, (i2, (i3, (i4, (i5, (i6, (i7, (i8, (i9, i10))))))))))))
        }
    }
  ...
  def transformP[F[_], G[_]](nt: (F ~> G)): AndXor11[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11]#Prod[F] => AndXor11[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11]#Prod[G] =
    (p: AndXor11[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11]#Prod[F]) => {
      val pr = p.run
      ProdT[G]((nt(pr.t1), (nt(pr.t2), (nt(pr.t3), (nt(pr.t4), (nt(pr.t5), (nt(pr.t6), (nt(pr.t7), (nt(pr.t8), (nt(pr.t9), (nt(pr.t10), nt(pr.t11))))))))))))
    }
  ...
  def transformC[F[_], G[_]](nt: (F ~> G)): AndXor11[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11]#Cop[F] => AndXor11[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11]#Cop[G] =
    (p: AndXor11[A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11]#Cop[F]) =>
      CopT[G](p.run.bimap(nt(_), _.bimap(nt(_), _.bimap(nt(_), _.bimap(nt(_), _.bimap(nt(_), _.bimap(nt(_), _.bimap(nt(_), _.bimap(nt(_), _.bimap(nt(_), _.bimap(nt(_), nt(_))))))))))))
  ...
  def sequenceP[F[_]](prod: Prod[F])(implicit A: Apply[F]): F[Prod[Id]] = {
    ...
    A.map(p.t1)((i0: A1) => (i1: A2) => (i2: A3) => (i3: A4) => (i4: A5) => (i5: A6) => (i6: A7) => (i7: A8) => (i8: A9) => (i9: A10) => (i10: A11) =>
      (i0, (i1, (i2, (i3, (i4, (i5, (i6, (i7, (i8, (i9, i10))))))))))))))))))))))(ProdT[Id](_))
  }
  ...
  def foldMapId[F[_], C](p: Prod[F])(map: Cop[Id] => C)(
    ...
    def uncons(p: Prod[F]): (List[Cop[Id]], Prod[F]) = {
      ...
      (List(ht1._1.map(inj(_: Id[A1])), ht2._1.map(inj(_: Id[A2])), ht3._1.map(inj(_: Id[A3])), ht4._1.map(inj(_: Id[A4])), ht5._1.map(inj(_: Id[A5])), ht6._1.map(inj(_: Id[A6])), ht7._1.map(inj(_: Id[A7])), ht8._1.map(inj(_: Id[A8])), ht9._1.map(inj(_: Id[A9])), ht10._1.map(inj(_: Id[A10])), ht11._1.map(inj(_: Id[A11]))).flatten,
        ProdT[F]((ht1._2, (ht2._2, (ht3._2, (ht4._2, (ht5._2, (ht6._2, (ht7._2, (ht8._2, (ht9._2, (ht10._2, ht11._2))))))))))))
    }
        ...
        case false => q.isEmpty match {
          ...
          case false => q.dequeue.run match {
            case -\/(x) => {
              val pr = prod.run
              val (h, t) = U(pr.t1)
              go(ProdT[F]((t, (pr.t2, (pr.t3, (pr.t4, (pr.t5, (pr.t6, (pr.t7, (pr.t8, (pr.t9, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A1])), M.append(out, map(inj(x))))
          }
          case \/-(-\/(x)) => {
              val pr = prod.run
              val (h, t) = U(pr.t2)
              go(ProdT[F]((pr.t1, (t, (pr.t3, (pr.t4, (pr.t5, (pr.t6, (pr.t7, (pr.t8, (pr.t9, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A2])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(-\/(x))) => {
              val pr = prod.run
              val (h, t) = U(pr.t3)
              go(ProdT[F]((pr.t1, (pr.t2, (t, (pr.t4, (pr.t5, (pr.t6, (pr.t7, (pr.t8, (pr.t9, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A3])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(\/-(-\/(x)))) => {
              val pr = prod.run
              val (h, t) = U(pr.t4)
              go(ProdT[F]((pr.t1, (pr.t2, (pr.t3, (t, (pr.t5, (pr.t6, (pr.t7, (pr.t8, (pr.t9, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A4])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(\/-(\/-(-\/(x))))) => {
              val pr = prod.run
              val (h, t) = U(pr.t5)
              go(ProdT[F]((pr.t1, (pr.t2, (pr.t3, (pr.t4, (t, (pr.t6, (pr.t7, (pr.t8, (pr.t9, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A5])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(\/-(\/-(\/-(-\/(x)))))) => {
              val pr = prod.run
              val (h, t) = U(pr.t6)
              go(ProdT[F]((pr.t1, (pr.t2, (pr.t3, (pr.t4, (pr.t5, (t, (pr.t7, (pr.t8, (pr.t9, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A6])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(\/-(\/-(\/-(\/-(-\/(x))))))) => {
              val pr = prod.run
              val (h, t) = U(pr.t7)
              go(ProdT[F]((pr.t1, (pr.t2, (pr.t3, (pr.t4, (pr.t5, (pr.t6, (t, (pr.t8, (pr.t9, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A7])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(\/-(\/-(\/-(\/-(\/-(-\/(x)))))))) => {
              val pr = prod.run
              val (h, t) = U(pr.t8)
              go(ProdT[F]((pr.t1, (pr.t2, (pr.t3, (pr.t4, (pr.t5, (pr.t6, (pr.t7, (t, (pr.t9, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A8])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(\/-(\/-(\/-(\/-(\/-(\/-(-\/(x))))))))) => {
              val pr = prod.run
              val (h, t) = U(pr.t9)
              go(ProdT[F]((pr.t1, (pr.t2, (pr.t3, (pr.t4, (pr.t5, (pr.t6, (pr.t7, (pr.t8, (t, (pr.t10, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A9])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(\/-(\/-(\/-(\/-(\/-(\/-(\/-(-\/(x)))))))))) => {
              val pr = prod.run
              val (h, t) = U(pr.t10)
              go(ProdT[F]((pr.t1, (pr.t2, (pr.t3, (pr.t4, (pr.t5, (pr.t6, (pr.t7, (pr.t8, (pr.t9, (t, pr.t11))))))))))),
                q ++= h.map(inj(_: Id[A10])), M.append(out, map(inj(x))))
          }
          case \/-(\/-(\/-(\/-(\/-(\/-(\/-(\/-(\/-(\/-(x)))))))))) => {
              val pr = prod.run
              val (h, t) = U(pr.t11)
              go(ProdT[F]((pr.t1, (pr.t2, (pr.t3, (pr.t4, (pr.t5, (pr.t6, (pr.t7, (pr.t8, (pr.t9, (pr.t10, t))))))))))),
