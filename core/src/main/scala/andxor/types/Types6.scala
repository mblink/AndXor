...
trait Types6 {
  ...
  trait Cop6LP {
    ...
    implicit def Cop6PLens0[F[_], A1, A2, A3, A4, A5, A6]: PLens[Cop6[F, A1, A2, A3, A4, A5, A6], F[A1]] =
      PLens(c => c.run match {
        case Left(x) => Some(StoreT.store[F[A1], Cop6[F, A1, A2, A3, A4, A5, A6]](x)(y => Cop6[F, A1, A2, A3, A4, A5, A6](Left(y))))
        case _ => None
      })

    implicit def Cop6PLens1[F[_], A1, A2, A3, A4, A5, A6]: PLens[Cop6[F, A1, A2, A3, A4, A5, A6], F[A2]] =
      PLens(c => c.run match {
        case Right(Left(x)) => Some(StoreT.store[F[A2], Cop6[F, A1, A2, A3, A4, A5, A6]](x)(y => Cop6[F, A1, A2, A3, A4, A5, A6](Right(Left(y)))))
        case _ => None
      })

    implicit def Cop6PLens2[F[_], A1, A2, A3, A4, A5, A6]: PLens[Cop6[F, A1, A2, A3, A4, A5, A6], F[A3]] =
      PLens(c => c.run match {
        case Right(Right(Left(x))) => Some(StoreT.store[F[A3], Cop6[F, A1, A2, A3, A4, A5, A6]](x)(y => Cop6[F, A1, A2, A3, A4, A5, A6](Right(Right(Left(y))))))
        case _ => None
      })

    implicit def Cop6PLens3[F[_], A1, A2, A3, A4, A5, A6]: PLens[Cop6[F, A1, A2, A3, A4, A5, A6], F[A4]] =
      PLens(c => c.run match {
        case Right(Right(Right(Left(x)))) => Some(StoreT.store[F[A4], Cop6[F, A1, A2, A3, A4, A5, A6]](x)(y => Cop6[F, A1, A2, A3, A4, A5, A6](Right(Right(Right(Left(y)))))))
        case _ => None
      })

    implicit def Cop6PLens4[F[_], A1, A2, A3, A4, A5, A6]: PLens[Cop6[F, A1, A2, A3, A4, A5, A6], F[A5]] =
      PLens(c => c.run match {
        case Right(Right(Right(Right(Left(x))))) => Some(StoreT.store[F[A5], Cop6[F, A1, A2, A3, A4, A5, A6]](x)(y => Cop6[F, A1, A2, A3, A4, A5, A6](Right(Right(Right(Right(Left(y))))))))
        case _ => None
      })

    implicit def Cop6PLens5[F[_], A1, A2, A3, A4, A5, A6]: PLens[Cop6[F, A1, A2, A3, A4, A5, A6], F[A6]] =
      PLens(c => c.run match {
        case Right(Right(Right(Right(Right(x))))) => Some(StoreT.store[F[A6], Cop6[F, A1, A2, A3, A4, A5, A6]](x)(y => Cop6[F, A1, A2, A3, A4, A5, A6](Right(Right(Right(Right(Right(y))))))))
        case _ => None
      })
